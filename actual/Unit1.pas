...
procedure ExtractResources; //При создании формы: извлекает и сохраняет файлы из ресурсов EXE, если еще не извлечено
...
//При создании формы: извлекает и сохраняет файлы из ресурсов EXE, если еще не извлечено
...
// формируем файлы конфигов kitty для выбранного бурстанка (если ещё нету)
  ...
  sleep(500);  //чтобы окна kitty успели  запуститься
